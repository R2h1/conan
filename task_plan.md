...
| 功能 | 优先级 | 说明 |
|------|--------|------|
| 标签云 | 中 | 可视化展示所有标签及使用频率 |
| 全文搜索 | 高 | 搜索笔记标题和内容 |
| 笔记关联 | 高 | 双向链接、相关笔记推荐 |
| 快速搜索面板 | 中 | Cmd/Ctrl+K 全局搜索面板 |
| 笔记收藏 | 低 | 标记重要笔记 |
| 笔记历史版本 | 低 | 查看/恢复到历史版本 |
...
| 阶段 | 状态 | 说明 |
|------|------|------|
| 1. 全文搜索 API | ⬜ 待开始 | 后端支持全文搜索 |
| 2. 前端搜索 UI | ⬜ 待开始 | 搜索框、结果列表、高亮 |
| 3. 笔记关联 API | ⬜ 待开始 | 获取相关笔记 |
| 4. 前端关联 UI | ⬜ 待开始 | 显示相关笔记列表 |
| 5. 标签云 | ⬜ 待开始 | 展示标签及使用频率 |
| 6. 快速搜索面板 | ⬜ 待开始 | Cmd/Ctrl+K 快捷键 |
