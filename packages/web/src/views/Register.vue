<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-[-1]">
      ...
      <div class="absolute top-1/4 -right-20 w-96 h-96 bg-primary/10 rounded-full blur-3xl"></div>
      <div class="absolute bottom-1/4 -left-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="w-full max-w-md px-4 animate-slide-up">
      ...
      <!-- 装饰性渐变圆圈 -->
      <div class="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-primary/20 to-transparent rounded-full -translate-y-16 -translate-x-16"></div>
      <div class="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-primary/10 to-transparent rounded-full translate-y-12 translate-x-12"></div>
      ...
      <CardHeader class="relative z-10">
        ...
        <CardTitle class="text-2xl font-bold text-center text-foreground">加入 Conan</CardTitle>
        <CardDescription class="text-center text-muted-foreground text-sm">
          已有账号？<RouterLink to="/login" class="text-primary-hover hover:text-primary-hover/80 hover:underline ml-1 font-medium">立即登录</RouterLink>
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form @submit.prevent="handleSubmit" class="space-y-3">
          <div class="space-y-2 group">
            <Label for="name" class="text-sm font-medium text-muted-foreground group-focus-within:text-primary transition-colors duration-200">用户名</Label>
            <div class="relative">
              <Input
                id="name"
                v-model="name"
          ...
          <div class="space-y-2 group">
            ...
            <div class="relative">
              <Input
                ...
                class="w-full border-input focus:border-primary focus:ring-primary/20 transition-all duration-200 pl-9"
              />
              <div class="absolute left-2.5 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary transition-colors duration-200 mt-px">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="space-y-2 group">
            ...
            <p class="text-xs text-muted-foreground mt-1">密码至少需要6位字符</p>
          </div>
          ...
          <div class="text-sm text-muted-foreground">
            <label class="flex items-start gap-2 cursor-pointer">
              <input type="checkbox" class="mt-0.5 rounded border-primary/40 text-primary focus:ring-primary/50 focus:ring-offset-0" required>
              <span>我同意 <a href="#" class="text-primary hover:text-primary-hover hover:underline transition-colors duration-200">服务条款</a> 和 <a href="#" class="text-primary hover:text-primary-hover hover:underline transition-colors duration-200">隐私政策</a></span>
            </label>
          </div>
